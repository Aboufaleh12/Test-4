      ...
      <div className="layout-container max-w-3xl relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight">
            Everything you need <br className="hidden md:block" /> to know about <span className="text-primary">credit repair.</span>
          </h2>
             ...
             return (
                ...
                >
                  ...
                  >
                    ...
                    <span className={`shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 border ${
                        isOpen 
